...
export const NoteModal: React.FC<NoteModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white/95 backdrop-blur-xl rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-hidden shadow-2xl border border-gray-200/50">
        ...
        <div className="p-8 space-y-6 overflow-y-auto max-h-[calc(90vh-180px)]">
          ...
          <div>
            ...
            <textarea
              ...
              rows={12}
              className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-200 resize-none bg-gray-50/50"
